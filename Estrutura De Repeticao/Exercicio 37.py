...
while True:
    ...
    print(f'Maior peso: {p_maior}')
    print(f'Menor peso: {p_menor}')
    print(f'Média peso: {soma_peso / c_peso:.2f}\n')
    print(f'Código da Maior altura: {cod_maior_altura}')
    print(f'Código da Menor altura: {cod_menor_altura}')
    print(f'Maior altura: {a_maior}')
    print(f'Menor altura: {a_menor}')
    print(f'Média altura: {soma_altura / c_altura:.2f}\n')
